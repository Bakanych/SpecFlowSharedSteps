...
namespace SpecFlowSharedSteps.Tests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("[Shared] Feature!")]
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Shared steps 1")]
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Shared steps 2")]
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Access parent context")]
        public virtual void AccessParentContext()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Access parent context", ((string[])(null)));
#line 11
this.ScenarioSetup(scenarioInfo);
#line 3
this.FeatureBackground();
#line 12
 testRunner.Given("Read parent1 from scenario context", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            this.ScenarioCleanup();
        }
    }
